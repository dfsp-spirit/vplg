#!/bin/bash
## update_db_from_new_pdb_files.sh -- uses the new PDB files (retrieved by the 'update_files_via_rsync_ script) to create the DSSP files and run plcc.
##
## Written by ts_2011
...
echo "$APPTAG ================ Updating database from PDB files ==================="
