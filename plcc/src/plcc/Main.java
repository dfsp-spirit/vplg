                ...
                if(dist < 39){
                    ...
                    if(((i > numOfLastBackboneAtomInResidue) && x.getChemSym().equals(" O")) 
                        ...
                        if(a.getResName3().equals("ASP") && b.getResName3().equals(sidechainNHAA) && y.hbondAtomAngleBetween(x, atoms_a.get(5))) {
                            ...
                            System.out.println("O -> NH sidechain-sidechain calculation failed for residues " + x.getPdbResNum() + " and " + y.getPdbResNum() + ". Possibly because of missing atoms of the sidechain in the pdb file.");
                        }
                        }
                    }
                    ...
                    if(((i > numOfLastBackboneAtomInResidue) && x.getChemSym().equals(" O")) 
                        ...
                        if(a.getResName3().equals("ASP") && b.getResName3().equals(sidechainOHAA) && y.hbondAtomAngleBetween(x, atoms_a.get(5))) {
                            ...
                            System.out.println("O -> OH sidechain-sidechain calculation failed for residues " + x.getPdbResNum() + " and " + y.getPdbResNum() + ". Possibly because of missing atoms of the sidechain in the pdb file.");
                        }
                        }
                    ...
                    if(((i > numOfLastBackboneAtomInResidue) && x.getChemSym().equals(" O")) 
                        ...
                        if(a.getResName3().equals(sidechainOHAA) && b.getResName3().equals("ARG") && x.hbondAtomAngleBetween(y, atoms_b.get(6))) {
                            ...
                            System.out.println("OH -> NH sidechain-sidechain calculation failed for residues " + x.getPdbResNum() + " and " + y.getPdbResNum() + ". Possibly because of missing atoms of the sidechain in the pdb file.");
                        }
                        }
                    ...
                    if(((i > numOfLastBackboneAtomInResidue) && x.getChemSym().equals(" N")) 
                        ...
                        if(a.getResName3().equals(sidechainNHAA) && b.getResName3().equals("SER") && x.hbondAtomAngleBetween(y, atoms_b.get(numOfLastBackboneAtomInResidue))) {
                            ...
                            System.out.println("NH -> OH sidechain-sidechain calculation failed for residues " + x.getPdbResNum() + " and " + y.getPdbResNum() + ". Possibly because of missing atoms of the sidechain in the pdb file.");
                        }
                        }
                    ...
                    if(((i > numOfLastBackboneAtomInResidue) && x.getChemSym().equals(" O")) 
                        ...
                        if(a.getResName3().equals("SER") && b.getResName3().equals(sidechainOHAA) && y.hbondAtomAngleBetween(x, atoms_a.get(numOfLastBackboneAtomInResidue))) {
                            ...
                            System.out.println("OH -> OH sidechain-sidechain calculation failed for residues " + x.getPdbResNum() + " and " + y.getPdbResNum() + ". Possibly because of missing atoms of the sidechain in the pdb file.");
                        }
                        }
                    }
                    ...
                    if(((i > numOfLastBackboneAtomInResidue) && x.getChemSym().equals(" N")) 
                        ...
                        if(a.getResName3().equals("ARG") && b.getResName3().equals(sidechainNHAA) && y.hbondAtomAngleBetween(x, atoms_a.get(6))) {
                            ...
                            System.out.println("NH -> NH sidechain-sidechain calculation failed for residues " + x.getPdbResNum() + " and " + y.getPdbResNum() + ". Possibly because of missing atoms of the sidechain in the pdb file.");
                        }
        ...
        if (sidechainPiRings.contains(b.getName3())) {           
            ...
            if (a.getName3().equals("CYS")) { 
                if (atoms_a.size() >= 6 && a.getHydrogenAtoms().size() >= 5) {       
                    ...
                    if (! (atoms_a.size() >= 5)) {
                    DP.getInstance().w("main", a.getName3() + " (" + a.getFancyName() + ") contains not enough atoms (no SG)."
                        + " Continue search in next residues.");
                    }
                    else {
                        DP.getInstance().w("main", a.getName3() + " (" + a.getFancyName() + ") contains not enough hydrogen (no HG)."
                            + " Continue search in next residues.");
                    }
                }         
            }
            ...
            if (sidechainOHAAs.contains(a.getName3())) {
                ...
                if ("SER".equals(a.getName3())) {
                    if (atoms_a.size() >= 6 && a.getHydrogenAtoms().size() >= 5) {
                        ...
                        if (! (atoms_a.size() >= 6)) {
                            DP.getInstance().w("main", a.getName3() + " (" + a.getFancyName() + ") contains not enough atoms (no OG).");
                        }
                        else {
                            DP.getInstance().w("main", a.getName3() + " (" + a.getFancyName() + ") contains not enough hydrogens (no HG).");
                        }
                    }
                }
                    ...
                    if (atoms_a.size() >= 6 && a.getHydrogenAtoms().size() >= 4) {
                        ...
                        if (! (atoms_a.size() >= 6)) {
                            DP.getInstance().w("main", a.getName3() + " (" + a.getFancyName() + ") contains not enough atoms (no OG1).");
                        }
                        else {
                            DP.getInstance().w("main", a.getName3() + " (" + a.getFancyName() + ") contains not enough hydrogens (no HG1).");
                        }
                    }
                }
                else {
                    if (atoms_a.size() >= 12 && a.getHydrogenAtoms().size() >= 9) {
                        ...
                        if (! (atoms_a.size() >= 12)) {
                            DP.getInstance().w("main", a.getName3() + " (" + a.getFancyName() + ") contains not enough atoms (no OH).");
                        }
                        else {
                            DP.getInstance().w("main", a.getName3() + " (" + a.getFancyName() + ") contains not enough hydrogens (no HH).");
                        }
                    }
                }
        ...
        if (sidechainPiRings.contains(a.getName3())) {
            ...
            if (b.getName3().equals("PRO")) {       
                if (atoms_b.size() >= 7 && b.getHydrogenAtoms().size() >= 7) {
                    ...
                    if (! (atoms_a.size() >= 7)) {
                        ...
                        DP.getInstance().w("main", b.getName3() + " (" + b.getFancyName() + ") contains not enough hydrogens."
                            + " Continue search in next residues.");
                    }
                }
            }
            ...
            if (b.getName3().equals("CYS")) {          
                if (atoms_b.size() >= 6 && b.getHydrogenAtoms().size() >= 5) {       
                    ...
                    if (! (atoms_a.size() >= 5)) {
                    DP.getInstance().w("main", b.getName3() + " (" + b.getFancyName() + ") contains not enough atoms (no SG)."
                        + " Continue search in next residues.");
                    }
                    else {
                        DP.getInstance().w("main", b.getName3() + " (" + b.getFancyName() + ") contains not enough hydrogen (no HG)."
                            + " Continue search in next residues.");
                    }
                }
            }
            ...
            if (sidechainOHAAs.contains(b.getName3())) {
                ...
                if ("SER".equals(b.getName3())) {
                    if (atoms_b.size() >= 6 && b.getHydrogenAtoms().size() >= 5) {
                        ...
                        if (! (atoms_b.size() >= 6)) {
                            DP.getInstance().w("main", b.getName3() + " (" + b.getFancyName() + ") contains not enough atoms (no OG).");
                        }
                        else {
                            DP.getInstance().w("main", b.getName3() + " (" + b.getFancyName() + ") contains not enough hydrogens (no HG).");
                        }
                    }
                }
                    ...
                    if (atoms_b.size() >= 6 && b.getHydrogenAtoms().size() >= 4) {
                        ...
                        if (! (atoms_b.size() >= 6)) {
                            DP.getInstance().w("main", b.getName3() + " (" + b.getFancyName() + ") contains not enough atoms (no OG1).");
                        }
                        else {
                            DP.getInstance().w("main", b.getName3() + " (" + b.getFancyName() + ") contains not enough hydrogens (no HG1).");
                        }
                    }
                }
                else {
                    if (atoms_b.size() >= 12 && b.getHydrogenAtoms().size() >= 9) {
                        ...
                        if (! (atoms_b.size() >= 12)) {
                            DP.getInstance().w("main", b.getName3() + " (" + b.getFancyName() + ") contains not enough atoms (no OH).");
                        }
                        else {
                            DP.getInstance().w("main", b.getName3() + " (" + b.getFancyName() + ") contains not enough hydrogens (no HH).");
                        }
                    }
                }
