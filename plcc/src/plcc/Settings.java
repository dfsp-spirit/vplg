...
public class Settings {
    ...
    public static Boolean setDefaults() {
        ...
        defSet("plcc_B_compute_tim", "false", "Whether to search for tim barrel motif in FGs if compute_motifs is true.");
        ...
        defSet("plcc_S_rnaSseCode", "R", "The SSE code used to mark a SSE of type RNA");
        ...
        // rna
        defSet("plcc_B_include_rna", "true", "Whether RNA should be parsed and included in graph formalism and visualisation (WIP)");
