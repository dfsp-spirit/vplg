...
public class Settings {
    ...
    public static Boolean setDefaults() {
        ...
        defSet("plcc_I_min_fgraph_size_write_to_file", "2", "The minimum size a folding graph must have in order to be written to a file in formats like GML. Settings this to 1 or 0 exports all of them to files, including isolated vertices.");        
        ...
        defSet("plcc_B_key_foldinggraph_arcs_allways_black", "false", "Whether the arcs of folding graphs should always be drawn in black in KEY notation. If set to false, they will use a color according to the relative orientation.");
        ...
        defSet("plcc_B_output_json", "true", "Whether to save computed protein graphs to text files in JSON format. Note that JSON format contains the full graph and is quite large. It is useful mainly for the web API.");
