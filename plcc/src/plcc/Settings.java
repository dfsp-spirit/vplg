...
public class Settings {
    ...
    public static Boolean setDefaults() {
        ...
        defSet("plcc_B_key_use_alternate_arcs", "false", "Whether to use alternative crossover arcs in KEY notation. The alternative arcs cut through other SSEs, the default ones use a vertical central line and shift the center to avoid this.");
