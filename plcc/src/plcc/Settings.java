...
public class Settings {
    ...
    public static Boolean setDefaults() {
        ...
        defSet("plcc_B_key_foldinggraph_arcs_allways_black", "true", "Whether the arcs of folding graphs should always be drawn in black in KEY notation. If set to false, they will use a color according to the relative orientation.");
