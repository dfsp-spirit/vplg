...
public class CssGenerator {
    ...
    public String getDefaultCSS() {
        ...
        sb.append(".protein_graph {margin-left: 0px;margin-top: 80px; -moz-border-radius: 15px;-webkit-border-radius: 15px;border-radius: 15px;background-color: #C0C0C0;padding: 20px 20px;width:90%;}");
        sb.append(".top_row { font-size:10pt; font-family:Arial,sans-serif; color:black;width:100%; }\n");
        sb.append(".navigation {margin-left: 0px; -moz-border-radius: 15px;-webkit-border-radius: 15px;border-radius: 15px;background-color: #C0C0C0;padding: 20px 20px;}");
