...
${OBJECTDIR}/ProteinGraph.o: ProteinGraph.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Inbproject -I/usr/include -include Graph.h -include GraphService.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProteinGraph.o ProteinGraph.cpp
...
${OBJECTDIR}/ProteinGraph_nomain.o: ${OBJECTDIR}/ProteinGraph.o ProteinGraph.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Inbproject -I/usr/include -include Graph.h -include GraphService.h -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProteinGraph_nomain.o ProteinGraph.cpp;\
	else  \
