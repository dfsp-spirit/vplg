...
LDLIBSOPTIONS=-lboost_graph -lboost_regex
...
${OBJECTDIR}/Database.o: Database.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Database.o Database.cpp

${OBJECTDIR}/GMLptglProteinParser.o: GMLptglProteinParser.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GMLptglProteinParser.o GMLptglProteinParser.cpp

${OBJECTDIR}/GraphPTGLPrinter.o: GraphPTGLPrinter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GraphPTGLPrinter.o GraphPTGLPrinter.cpp

${OBJECTDIR}/GraphPrinter.o: GraphPrinter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GraphPrinter.o GraphPrinter.cpp

${OBJECTDIR}/GraphService.o: GraphService.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GraphService.o GraphService.cpp
...
${OBJECTDIR}/ProteinGraphService.o: ProteinGraphService.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProteinGraphService.o ProteinGraphService.cpp

${OBJECTDIR}/Scoring.o: Scoring.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Scoring.o Scoring.cpp
...
${TESTDIR}/tests/newtestclass2.o: tests/newtestclass2.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestclass2.o tests/newtestclass2.cpp


${TESTDIR}/tests/newtestrunner2.o: tests/newtestrunner2.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestrunner2.o tests/newtestrunner2.cpp


${TESTDIR}/tests/newtestclass1.o: tests/newtestclass1.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestclass1.o tests/newtestclass1.cpp


${TESTDIR}/tests/newtestrunner1.o: tests/newtestrunner1.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestrunner1.o tests/newtestrunner1.cpp


${TESTDIR}/tests/newtestclass5.o: tests/newtestclass5.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestclass5.o tests/newtestclass5.cpp


${TESTDIR}/tests/newtestrunner5.o: tests/newtestrunner5.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestrunner5.o tests/newtestrunner5.cpp


${TESTDIR}/tests/newtestclass.o: tests/newtestclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestclass.o tests/newtestclass.cpp
...
${TESTDIR}/tests/newtestclass4.o: tests/newtestclass4.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestclass4.o tests/newtestclass4.cpp
...
${OBJECTDIR}/Database_nomain.o: ${OBJECTDIR}/Database.o Database.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Werror -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Database_nomain.o Database.cpp;\
	else  \
...
${OBJECTDIR}/GMLptglProteinParser_nomain.o: ${OBJECTDIR}/GMLptglProteinParser.o GMLptglProteinParser.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Werror -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GMLptglProteinParser_nomain.o GMLptglProteinParser.cpp;\
	else  \
...
${OBJECTDIR}/GraphPTGLPrinter_nomain.o: ${OBJECTDIR}/GraphPTGLPrinter.o GraphPTGLPrinter.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Werror -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GraphPTGLPrinter_nomain.o GraphPTGLPrinter.cpp;\
	else  \
...
${OBJECTDIR}/GraphPrinter_nomain.o: ${OBJECTDIR}/GraphPrinter.o GraphPrinter.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Werror -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GraphPrinter_nomain.o GraphPrinter.cpp;\
	else  \
...
${OBJECTDIR}/GraphService_nomain.o: ${OBJECTDIR}/GraphService.o GraphService.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Werror -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GraphService_nomain.o GraphService.cpp;\
	else  \
...
${OBJECTDIR}/ProteinGraphService_nomain.o: ${OBJECTDIR}/ProteinGraphService.o ProteinGraphService.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Werror -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProteinGraphService_nomain.o ProteinGraphService.cpp;\
	else  \
...
${OBJECTDIR}/Scoring_nomain.o: ${OBJECTDIR}/Scoring.o Scoring.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Werror -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Scoring_nomain.o Scoring.cpp;\
	else  \
...
${OBJECTDIR}/main_nomain.o: ${OBJECTDIR}/main.o main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Werror -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_nomain.o main.cpp;\
	else  \
