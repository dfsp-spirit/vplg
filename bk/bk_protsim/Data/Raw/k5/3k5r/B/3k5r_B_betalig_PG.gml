graph [
  id 1
  label "VPLG Protein Graph 3k5r-B-betalig[14,14]"
  comment "date=07-OCT-09|keywords=CADHERIN, MOUSE, STRUCTURAL PROTEIN|graphclass=protein graph|pdb_org_common=MOUSE|title=CRYSTAL STRUCTURE OF MOUSE T-CADHERIN EC1 EC2|resolution=2.0|pdb_all_chains=A, B|pdb_mol_id=1|pdb_mol_name=CADHERIN 13|pdbid=3k5r|graphtype=betalig|experiment=X-RAY DIFFRACTION|chainid=B|pdb_org_sci=MUS MUSCULUS|pdb_ec_number=|header=STRUCTURAL PROTEIN|"
  directed 0
  isplanar 0
