graph [
  id 1
  label "VPLG Protein Graph 1zxk-B-beta[7,7]"
  comment "date=08-JUN-05|keywords=CADHERIN, STRAND DIMER, CELL ADHESION|graphclass=protein graph|pdb_org_common=HOUSE MOUSE|title=CRYSTAL STRUCTURE OF CADHERIN8 EC1 DOMAIN|resolution=2.0|pdb_all_chains=A, B|pdb_mol_id=1|pdb_mol_name=CADHERIN-8|pdbid=1zxk|graphtype=beta|experiment=X-RAY DIFFRACTION|chainid=B|pdb_org_sci=MUS MUSCULUS|pdb_ec_number=|header=CELL ADHESION|"
  directed 0
  isplanar 0
