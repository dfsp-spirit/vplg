graph [
  id 1
  label "VPLG Protein Graph 1zvn-A-beta[7,7]"
  comment "date=02-JUN-05|keywords=CADHERIN, CELL ADHESION|graphclass=protein graph|pdb_org_common=CHICKEN|title=CRYSTAL STRUCTURE OF CHICK MN-CADHERIN EC1|resolution=2.16|pdb_all_chains=A, B|pdb_mol_id=1|pdb_mol_name=CADHERIN 1|pdbid=1zvn|graphtype=beta|experiment=X-RAY DIFFRACTION|chainid=A|pdb_org_sci=GALLUS GALLUS|pdb_ec_number=|header=CELL ADHESION|"
  directed 0
  isplanar 0
