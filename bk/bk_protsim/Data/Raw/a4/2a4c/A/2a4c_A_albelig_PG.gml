graph [
  id 1
  label "VPLG Protein Graph 2a4c-A-albelig[8,7]"
  comment "date=28-JUN-05|keywords=CADHERIN, EXTRACELLULAR DOMAIN, DIMER, CELL ADHESION|graphclass=protein graph|pdb_org_common=HOUSE MOUSE|title=CRYSTAL STRUCTURE OF MOUSE CADHERIN-11 EC1|resolution=2.9|pdb_all_chains=A, B|pdb_mol_id=1|pdb_mol_name=CADHERIN-11|pdbid=2a4c|graphtype=albelig|experiment=X-RAY DIFFRACTION|chainid=A|pdb_org_sci=MUS MUSCULUS|pdb_ec_number=|header=CELL ADHESION|"
  directed 0
  isplanar 0
