graph [
  id 1
  label "VPLG Protein Graph 3ppe-A-betalig[17,14]"
  comment "date=24-NOV-10|keywords=EXTRACELLULAR CADHERIN (EC) DOMAIN, BETA BARREL, IG-DOMAIN LIKE,DOMAIN SWAPPED DIMER INTERFACE, CALCIUM DEPENDENT CELL-CELLADHESION, CELL SURFACE, CELL ADHESION|graphclass=protein graph|pdb_org_common=BANTAM,CHICKENS|title=CRYSTAL STRUCTURE OF CHICKEN VE-CADHERIN EC1-2|resolution=2.1|pdb_all_chains=A, B|pdb_mol_id=1|pdb_mol_name=VASCULAR ENDOTHELIAL CADHERIN|pdbid=3ppe|graphtype=betalig|experiment=X-RAY DIFFRACTION|chainid=A|pdb_org_sci=GALLUS GALLUS|pdb_ec_number=|header=CELL ADHESION|"
  directed 0
  isplanar 0
