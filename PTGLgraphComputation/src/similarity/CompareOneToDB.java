...
public class CompareOneToDB {
    ...
    public static void performSSEStringComparison(String patternSSEString) {
        ArrayList<ComparisonResult> res = CompareOneToDB.getMostSimilarToSSEString(patternSSEString, Settings.getInteger("PTGLgraphComputation_I_search_similar_num_results"), Settings.get("PTGLgraphComputation_S_search_similar_graphtype"), true);
        ...
        System.out.println("Similarity search for PDB ID '" + Settings.get("PTGLgraphComputation_B_search_similar_PDBID") + "' chain '" + Settings.get("PTGLgraphComputation_B_search_similar_chainID") + "' graph type '" + Settings.get("PTGLgraphComputation_S_search_similar_graphtype") + "' complete (" + res.size() + " results), exiting.");        
    }
    ...
    public static void performGraphSetComparison() {
        ArrayList<ComparisonResult> res = CompareOneToDB.getMostSimilarByGraphSetBased(Settings.get("PTGLgraphComputation_S_search_similar_PDBID"), Settings.get("PTGLgraphComputation_S_search_similar_chainID"), Settings.get("PTGLgraphComputation_S_search_similar_graphtype"), Settings.getInteger("PTGLgraphComputation_I_search_similar_num_results"));
    ...
    public static void performGraphCompatGraphComparison() {
        ArrayList<ComparisonResult> res = CompareOneToDB.getMostSimilarByCompatibilityGraph(Settings.get("PTGLgraphComputation_S_search_similar_PDBID"), Settings.get("PTGLgraphComputation_S_search_similar_chainID"), Settings.get("PTGLgraphComputation_S_search_similar_graphtype"), Settings.getInteger("PTGLgraphComputation_I_search_similar_num_results"));
