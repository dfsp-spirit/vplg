"""
Script is owned by wwPDB, downloaded april 2021 from https://mmcif.wwpdb.org/docs/sw-examples/python/html/assemblies.html
Expects a Cif File of an asymmetric unit as input.
Only works with python2.
Output are the Cif files of all biological assemblies of the structure.
Example usage:
    > python2 create_biological_assembly_ciffile.py 1out.cif
"""
