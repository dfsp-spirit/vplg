	...
	<div class="wrapper">
		...
		<div class="container" id="help">
			<div class="sectionPointerBox">
				<p>
					<a href="/biomedical_examples.php"><i class="glyphicon glyphicon-arrow-up"></i> Biomedical examples <i class="glyphicon glyphicon-arrow-up"></i></a><br>
					Previous section
				</p>
			</div>
			<br>
			...
			<p>If you need help using the website or interpreting the results, do not hesitate to <a href="http://ptgl.uni-frankfurt.de/contact.php">contact</a> us.</p>
			...
			<ul>
				...
				<li class="noBullets"> <a href="#faqs"> Frequently Asked Questions </a> </li>
			</ul>
			...
			<ul>
				<li> Check that the entered PDB ID (4 characters) is correct. </li>
				<li> PTGL is currently updated annually, check that the structure is not too new. You can find the date of the last update <a href="http://ptgl.uni-frankfurt.de/content.php">here (content)</a>. </li>
				<li> Structures with a resolution worse than 4.5 Angstroem are excluded. </li>
				<li> Structures containing less than 30 residues are excluded. </li>
			</ul>

			<b>What can I do about it?</b>
			<p>You can compute your own results with the open source <a href="http://www.bioinformatik.uni-frankfurt.de/tools/vplg/">VPLG</a> software.</p>
			...
			<ul>
				...
				<li> If your browser fails to load the image, but the download button exists, you can download and view it manually with an image viewer of your choice. </li>
			</ul>
