...
<?php
    ...
    */
    ...
    // ALL THE DATA ABOVE is now read from content_data.php, which is auto-generated by the maintenance PTGL page.
    
    include('./temp_data/content_data.php'); 
    
    $sses_in_graphtypes_labels = array("Alpha", "Beta", "Alpha-Beta", "Alphalig", "Betalig", "Alpha-Betalig");
    $sses_in_graphtype_alpha = array("Alpha", $num_graphs_alpha, $num_graphs_alpha_with_barrel, $num_sses_in_alphagraphs);
    $sses_in_graphtype_beta = array("Beta", $num_graphs_beta, $num_graphs_beta_with_barrel, $num_sses_in_betagraphs);
    $sses_in_graphtype_albe = array("Alpha-Beta", $num_graphs_albe, $num_graphs_albe_with_barrel, $num_sses_in_albegraphs);
    $sses_in_graphtype_alphalig = array("Alphalig", $num_graphs_alphalig, $num_graphs_alphalig_with_barrel, $num_sses_in_alphaliggraphs);
    $sses_in_graphtype_betalig = array("Betalig", $num_graphs_betalig, $num_graphs_betalig_with_barrel, $num_sses_in_betaliggraphs);
    $sses_in_graphtype_albelig = array("Alpha-Betalig", $num_graphs_albelig, $num_graphs_albelig_with_barrel, $num_sses_in_albeliggraphs);
    
    $sses_by_type_labels = array("Helix", "Strand", "Ligand");
    $sses_by_type = array($num_helices, $num_strands, $num_ligands);

    $total_contacts_by_type_labels = array("Mixed", "Parallel", "Antiparallel", "Ligand");
    $total_contacts_by_type = array($num_contacts_mixed, $num_contacts_parallel, $num_contacts_antiparallel, $num_contacts_ligand);
