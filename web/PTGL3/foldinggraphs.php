...
<body id="customBackground">
	...
	<div class="container" id="publications">
		...
		<li>the KEY notation: only SSEs of the folding graph are shown, order is spatial, and edges follow the SSEs in sequence order (N to C terminus). Note that it is not possible to define a spatial ordering for <dfn title="A graph is bifurcated if any vertex in the graph has more than 2 neighbors.">bifurcated graphs</dfn>, so such graphs do not have a KEY notation.</li>
		</ul>
